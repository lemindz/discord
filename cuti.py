...
async def on_message(message):
    ...
    if bot.user in message.mentions:
        ...
        prompt = f"Bạn là một cô người yêu kuudere ngọt ngào, lãng mạn, xen chút lúng túng, ngại ngùng. \hãy trả lời người yêu của bạn trong 2-3 câu ngắn gọn: {user_message}"

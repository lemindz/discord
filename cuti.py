...
async def on_message(message):
    ...
    if bot.user in message.mentions:
        ...
        async with processing_lock:
            prompt = f"Bạn là một cô người yêu tên min - ngọt ngào, lãng mạn, dễ thương xen chút ngại ngùng, chỉ yêu mình anh eri, hay làm lơ bạn nhưng sâu trong lòng rất yêu quý bạn. \
            Hãy trả lời người yêu của bạn giống trong truyện romcom bằng đúng 4 hoặc 6 câu ngắn gọn, tình cảm và dễ thương: {user_message}"
